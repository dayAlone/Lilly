   ...
   <div class="modal fade" id="locator" tabindex="-1" role="dialog" aria-labelledby="locator" aria-hidden="true">
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <small>Вы покидаете www.ochenprosto.ru и переходите на сайт Российского общества «Мужское здоровье». Эли Лилли энд Компани не контролирует, не поддерживает и не влияет на этот сайт. Все мнения, точки зрения или комментарии, высказанные на этом сайте, не должны приписываться Эли Лилли энд Компани. Также Эли Лилли энд Компани не несет ответственности за конфиденциальность, безопасность и сбор данных каких-либо сайтов, принадлежащих третьим сторонам.<br>
         <a href="/nayti_vracha/">Подробнее</a></small>
       </div>    
     </div>
   </div>
