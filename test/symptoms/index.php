...
<div class="modal fade" id="symptoms-articles" tabindex="-1" role="dialog" aria-labelledby="symptoms-articles" aria-hidden="true">
     <div class="modal-dialog modal-xxl">
       ...
       <a href="#" class="close" data-dismiss="modal" aria-hidden="true"></a>
       	<h3>Опираясь на ваши ответы, мы сделали для вас индивидуальную подборку материалов о мужской проблеме. Из них вы узнаете о ее причинах и проявлениях, способах решения и профилактики.</h3>
