...
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Auth/AssertionCredentials.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Cache/File.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Cache/Memcache.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Config.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Collection.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Exception.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/IO/Curl.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/IO/Stream.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Model.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Service.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/include/Google/Service/Resource.php';
